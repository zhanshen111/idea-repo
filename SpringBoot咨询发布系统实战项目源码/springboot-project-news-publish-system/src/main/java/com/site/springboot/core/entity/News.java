...
public class News {
    ...
    public News(Long newsId, String newsTitle, Long newsCategoryId, String newsCoverImage, String newsContent, Byte newsStatus, Long newsViews, Byte isDeleted, Date createTime, Date updateTime) {
        this.newsId = newsId;
